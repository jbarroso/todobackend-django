...
class TodoListCreateAPIViewTestCase(APITestCase):
    ...
    def setUp(self):
        Todos.objects.create(title='Todo1')
        Todos.objects.create(title='Todo2')
        Todos.objects.create(title='Todo3')
    ...
    def test_get_todos(self):
        Todos.objects.create(title='Todo5')
...
class TodoDetailAPIViewTestCase(APITestCase):
    ...
    def setUp(self):
        self.todo = Todos.objects.create(title='Todo1')
    ...
    def test_todo_object_update(self):
        response = self.client.put(self.url, {"title": "New Todo1"})
        response_data = json.loads(response.content)
